...
import 'package:antoinette/app/modules/checkin/views/check_in_screen.dart';
import 'package:antoinette/app/modules/common/views/notification_screen.dart';
import 'package:antoinette/app/modules/common/views/push_notication_screen.dart';
import 'package:antoinette/app/modules/home/widgets/product_item_shimmer.dart';
import 'package:antoinette/app/modules/home/widgets/session_item_shimmer.dart';
import 'package:antoinette/app/modules/letters/views/letter_screen.dart';
import 'package:antoinette/app/modules/home/models/grid_view_model.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final AllSessionController allSessionController =
      Get.find<AllSessionController>();
  final ProfileController profileController = Get.find<ProfileController>();
  ...
  void initState() {
    super.initState();
    // FCM ইনিশিয়ালাইজ এবং নোটিফিকেশন হ্যান্ডলিং
  ...
  void _setupFirebaseMessaging() async {
    ...
    // ফোরগ্রাউন্ড নোটিফিকেশন হ্যান্ডলিং
    ...
    // নোটিফিকেশনে ক্লিক করলে (অ্যাপ ব্যাকগ্রাউন্ডে থাকলে)
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      print('Message clicked: ${message.data}');
      Navigator.pushNamed(context, PushNotificationScreen.routeName);
    });

    // অ্যাপ টার্মিনেটেড অবস্থায় নোটিফিকেশন ক্লিক করলে
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SeeAllSection(
                    title:
                        'Soft landings for hard days. Because not everything should be carried alone.',
                    ontap: () {
                      Navigator.pushNamed(context, SessionScreen.routeName,
                          arguments: true);
                    },
