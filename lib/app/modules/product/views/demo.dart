...
//   final ProcuctDetailsController procuctDetailsController =
//       Get.find<ProcuctDetailsController>();
...
//   @override
//   void initState() {
//     print('Check out page e asche');
//     procuctDetailsController.getProductDetails(widget.productId);
...
//                 heightBox12,
//                 GetBuilder<ProcuctDetailsController>(builder: (controller) {
//                   if (controller.inProgress) {
//                     return Center(child: CircularProgressIndicator());
//                   }
//                   price = controller.productModel!.amount!;
//                   discount = controller.productModel!.discount!;
//                   print('Price : ${controller.productModel?.amount}');
//                   return Container(
//                     height: 91.h,
...
//         procuctDetailsController.productDetailsModel!.data!.sId!,
//         quantity,
//         price,
//         totalPrice,
//         discount.toString(),
